...
const string strMessageMagic = "gmcash Signed Message:\n";
...
// miner's coin base reward premine -- Premined: 95.200.000
int64_t GetProofOfWorkReward(int64_t nFees)
{
        int64_t nSubsidy = 1 * COIN;
        
        if (pindexBest->nHeight+1 < 4)
            nSubsidy = 1033334 * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "gmcash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "gmcash.com Block";
        CTransaction txNew;
        txNew.nTime = 1512621780;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1512621780;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2204440;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x990e36e0e60056d1c807c2770c406f6629527d40d1cba08ff6d6e361444578aa"));
        block.print();
